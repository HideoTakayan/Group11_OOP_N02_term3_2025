...
public class LecturerUserController {
    ...
    public String updateProfile(@ModelAttribute Lecturer lecturer, HttpSession session) {
    ...
    public String addClassSection(@RequestParam String classId, HttpSession session) {
        Lecturer lecturer = lecturerDao.getLecturerByEmail((String) session.getAttribute("userEmail"));
    ...
    public String removeClassSection(@RequestParam String classId) {
        ClassSection cs = classSectionDao.getClassSectionById(classId);
        if (cs != null) {
    ...
    public String removeStudentFromClass(@RequestParam String registerId) {
    ...
    public String updateSchedule(@ModelAttribute Environment env, HttpSession session) {
    ...
    public String deleteSchedule(@RequestParam String enviromentId) {
    ...
    public String addSchedule(@ModelAttribute Environment env, HttpSession session) {
    ...
    public String deleteExam(@RequestParam String subjectName) {
