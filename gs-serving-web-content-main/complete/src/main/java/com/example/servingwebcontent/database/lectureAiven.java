...
public class lectureAiven {
    public void insertLecture(Lecture lecture) {
        try (Connection conn = aivenConnection.getConnection()) {
            ...
            System.out.println("Error inserting lecture: " + e.getMessage());
        }
    }
    ...
    public ArrayList<Lecture> getLectureList() {
        ...
        try (Connection conn = aivenConnection.getConnection()) {
            String sql = "SELECT l.lecture_id, p.person_id, p.name, p.address, p.email, l.department " +
                    "FROM lecture l JOIN person p ON l.person_id = p.person_id";
            ...
            System.out.println("Error retrieving lectures: " + e.getMessage());
        }
        return lectures;
    }
    ...
    public Lecture getLectureById(String lectureId) {
        try (Connection conn = aivenConnection.getConnection()) {
            String sql = "SELECT l.lecture_id, p.person_id, p.name, p.address, p.email, l.department " +
                    "FROM lecture l JOIN person p ON l.person_id = p.person_id WHERE l.lecture_id = ?";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            System.out.println("Error getting lecture: " + e.getMessage());
        }
        return null;
    }
